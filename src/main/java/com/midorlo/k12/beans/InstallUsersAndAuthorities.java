...
public class InstallUsersAndAuthorities implements CommandLineRunner {
    ...
    public InstallUsersAndAuthorities(UserRepository userRepository,
    ...
    public void run(String... args) throws Exception {
        userRepository.findAll().stream()
                      ...
                      .findFirst()
                      .ifPresentOrElse(user -> log.warn("Accounts already installed!"),
                                       () -> log.info("Installed Accounts: {}", userRepository.saveAll(
                                           List.of(new User().setActivated(true)
                                                             .setLogin("admin")
