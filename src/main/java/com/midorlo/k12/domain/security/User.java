...
import com.midorlo.k12.domain.util.AbstractAuditingEntity;
...
public class User extends AbstractAuditingEntity implements Serializable {
    ...
    public User setCreatedBy(String createdBy) {
        return (User) super.setCreatedBy(createdBy);
    }

    @Override
    public User setCreatedDate(Instant createdDate) {
        return (User) super.setCreatedDate(createdDate);
    }

    @Override
    public User setLastModifiedBy(String lastModifiedBy) {
        return (User) super.setLastModifiedBy(lastModifiedBy);
    }

    @Override
    public User setLastModifiedDate(Instant lastModifiedDate) {
        return (User) super.setLastModifiedDate(lastModifiedDate);
    }
}
