 ...
 * DataSource if necessary. <p> By default, this asynchronous version only works when using the "dev" profile.<p> The
 * standard
...
public class AsyncSpringLiquibase extends DataSourceClosingSpringLiquibase {
     ...
     */
    public static final String EXCEPTION_MESSAGE      = "Liquibase could not start correctly, your database is NOT " +
                                                        "ready: " +
                                                        "{}";
