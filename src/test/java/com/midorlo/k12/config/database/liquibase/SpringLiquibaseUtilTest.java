...
class SpringLiquibaseUtilTest {
    ...
    void createSpringLiquibaseFromNormalDataSource() {
        ...
        SpringLiquibase liquibase = SpringLiquibaseUtil.createSpringLiquibase(null, liquibaseProperties, normalDataSource, null);
        assertThat(liquibase)
            .isNotInstanceOf(DataSourceClosingSpringLiquibase.class)
            .extracting(SpringLiquibase::getDataSource)
    ...
    void createSpringLiquibaseFromLiquibaseProperties() {
        ...
        SpringLiquibase liquibase = SpringLiquibaseUtil.createSpringLiquibase(null, liquibaseProperties, null, dataSourceProperties);
        assertThat(liquibase)
    ...
    void createAsyncSpringLiquibaseFromLiquibaseDataSource() {
        ...
        AsyncSpringLiquibase liquibase = SpringLiquibaseUtil.createAsyncSpringLiquibase(null, null, liquibaseDatasource, null, null, null);
