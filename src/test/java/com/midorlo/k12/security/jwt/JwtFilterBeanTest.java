...
class JwtFilterBeanTest {
    ...
    private JwtFilterBean jwtFilterBean;
    ...
    public void setup() {
        ...
        jwtFilterBean = new JwtFilterBean(tokenProvider);
    ...
    void testJWTFilter() throws Exception {
        UsernamePasswordAuthenticationToken authentication = new UsernamePasswordAuthenticationToken(
            "test-user",
            "test-password",
            Collections.singletonList(new SimpleGrantedAuthority(ApplicationConstants.SecurityConstants.ROLE_USER))
        );
