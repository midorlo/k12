...
class UserDetailsServiceImplIT {
    ...
    public void init() {
        ...
        userOne.setPasswordHash(RandomStringUtils.random(60));
        ...
        userTwo.setPasswordHash(RandomStringUtils.random(60));
        ...
        userThree.setPasswordHash(RandomStringUtils.random(60));
