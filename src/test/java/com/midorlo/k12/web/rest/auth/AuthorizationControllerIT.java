...
public class AuthorizationControllerIT {
    ...
    void testNonAuthenticatedUser() throws Exception {
        restAccountMockMvc
            .perform(get("/api/identity/authenticate").accept(MediaType.APPLICATION_JSON))
    ...
    void testGetExistingAccount() throws Exception {
        ...
        restAccountMockMvc
            ...
            .andExpect(jsonPath("$.authorities").value(ROLE_ADMIN));
    }

    @Test
    void testGetUnknownAccount() throws Exception {
        restAccountMockMvc
            .perform(get("/api/identity/account").accept(MediaType.APPLICATION_PROBLEM_JSON))
    ...
    void testRegisterValid() throws Exception {
        ...
        validUser.setAuthorities(Collections.singleton(ROLE_USER));
    ...
    void testRegisterInvalidLogin() throws Exception {
        ...
        invalidUser.setAuthorities(Collections.singleton(ROLE_USER));
    ...
    void testRegisterDuplicateLogin() throws Exception {
        ...
        firstUser.setAuthorities(Collections.singleton(ROLE_USER));
    ...
    void testRegisterAdminIsIgnored() throws Exception {
        ...
        validUser.setImageUrl("http://placehold.it/50x50");
        validUser.setLangKey(ApplicationConstants.DEFAULT_LANGUAGE);
        validUser.setAuthorities(Collections.singleton(ROLE_ADMIN));
        ...
        assertThat(userDup.get().getClearances()).hasSize(1).containsExactly(clearanceRepository.findByName(ROLE_USER).orElse(null));
    }
    ...
    void testSaveAccount() throws Exception {
        ...
        userDTO.setAuthorities(Collections.singleton(ROLE_ADMIN));
    ...
    void testRequestPasswordReset() throws Exception {
        ...
        restAccountMockMvc
            .perform(post("/api/identity/account/reset-password/init").content("password-reset@example.com"))
            .andExpect(status().isOk());
    }
    ...
    void testRequestPasswordResetUpperCaseEmail() throws Exception {
        ...
        restAccountMockMvc
            .perform(post("/api/identity/account/reset-password/init").content("password-reset-upper-case@EXAMPLE.COM"))
            .andExpect(status().isOk());
    }
    ...
    void testFinishPasswordReset() throws Exception {
        ...
        restAccountMockMvc
            .perform(
                post("/api/identity/account/reset-password/finish")
                    .contentType(MediaType.APPLICATION_JSON)
